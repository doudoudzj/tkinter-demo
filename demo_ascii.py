...
class show:
    ...
    def __init__(self):
        ...
        self.t_show = Text(
            self.frm_M, width=20, height=5, font=('Verdana', 15))
    ...
    def search(self):
        ...
        if tmp_char != '':
            if not tmp_char in self.char_info_hash:
                ...
                self.t_show.insert(
                    '1.0',
                    '十六进制:' + '\t' + self.char_info_hash[tmp_char][2] + '\n')
                self.t_show.insert(
                    '1.0',
    ...
    def load_config_file(self):
        ...
        for line in f:
            ...
            self.num_char[int(chunk[0])] = chunk[2]
            self.char_num[chunk[2]] = int(chunk[0])
            self.num_info_hash[chunk[0]] = [chunk[0], chunk[1], chunk[2]]
            self.char_info_hash[chunk[2]] = [chunk[0], chunk[1], chunk[2]]
