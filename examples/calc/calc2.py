...
# https://www.cnblogs.com/xiaobingbing/p/8016997.html
...
class calculator:
    ...
    def menus(self):
        ...
        filemenu.add_command(label='科学型(S)            Alt+2',
                             command=self.myfunc)
        filemenu.add_command(label='程序员(P)            Alt+3',
                             command=self.myfunc)
        ...
        filemenu.add_separator()
        # 添加选项卡
        filemenu.add_command(label='基本(B)             Ctrl+F4',
                             command=self.myfunc)
    ...
    def layout(self):
        ...
        result.set(0)
        show_label = tkinter.Label(self.root,
                                   bd=3,
                                   bg='white',
                                   font=('宋体', 30),
                                   anchor='e',
        ...
        # 功能按钮CE
        button_ce = tkinter.Button(self.root,
                                   text='CE',
