...
def cal():
    ...
    entry.grid(
        row=0, column=0, columnspan=4, sticky=N + W + S + E, padx=5, pady=5)
    ...
    button0.grid(
        row=4, column=0, columnspan=2, padx=3, pady=5, sticky=N + S + E + W)
    ...
    button17 = Button(
        ...
        activebackground=button_active_bg)
    button17.grid(
        row=5, column=2, columnspan=2, padx=3, pady=5, sticky=N + S + E + W)
