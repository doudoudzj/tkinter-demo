#!/usr/bin/env python3
# -*- coding: UTF-8 -*-
# 使用tkinter做界面之拆分窗口（SplitWindow）
# https://blog.csdn.net/chl0000/article/details/7657873
...
class MainFrame(Frame):
    def __init__(self, master=None, cnf={}, **kw):
        ...
        self.MidLabel = Label(
            self.master, text='', width=0, cursor='sb_h_double_arrow')
